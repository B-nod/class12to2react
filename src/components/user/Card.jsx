...
const Card = (props) => {
    const{title,image,id, description, price} = props.data
  return (
    <>
    

<div className="max-w-sm w-[23%]  bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 hover:-translate-y-3">
    <Link to="#">
